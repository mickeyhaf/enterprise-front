...
export function AdminSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed lg:static inset-y-0 left-0 z-50 w-56 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col transition-transform lg:translate-x-0",
